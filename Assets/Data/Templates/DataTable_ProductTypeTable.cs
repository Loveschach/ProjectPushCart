...
{
	public override Color[] NewColumnColors { get; set; } = new Color[]{new Color(1f, 1f, 1f), new Color(0.9921569f, 0.6f, 0.03137255f), new Color(0.09767064f, 0.6037736f, 0f), new Color(0.6039216f, 0f, 0.4592783f), new Color(0.3773585f, 0f, 0.364374f), new Color(0.1946957f, 0f, 0.6039216f), new Color(0.09767064f, 0.6037736f, 0f)};
	public override int[] NewColumnWidths { get; set; } = {100, 100, 200, 60, 60, 60, 60};
...
public class DataTableRow_ProductTypeTable: DataTableRow
{
	...
	[SerializeField] public int DepthUnits;
	[SerializeField] public AisleType Aisle;
